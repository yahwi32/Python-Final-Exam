...
root = Tk()
# root.resizable(0, 0)
image = PhotoImage(file='C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\images\\coffeeShop-ico.png')
...
welcome_label = Label(text='     © PYTHON FINAL EXAM PROJECT', bg='#fd6a36', font=("yu gothic ui", 15, "bold"), fg='black')
