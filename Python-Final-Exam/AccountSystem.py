...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        brand_name = Label(landing_page, text='LAP TRINH PYTHON', bg='#ffffff', fg='#ff6c38', font=("yu gothic ui", 15, "bold"))
        brand_name.place(x=83, y=53)

        text = Label(landing_page, text="FINAL EXAM", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt = " • 102200134 - Nguyen Nho Gia Huy    \n • 102200131 - Hoang Huan  \t "
        text2 = Label(landing_page, text=txt,
                      fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text2.place(x=15, y=180)

        # ====== LOGO ==========
        coffeeImage = Image.open('C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\images\\coffee3.gif')
        ...
        brand_name = Label(sign_in, text='LAP TRINH PYTHON', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_in, text="FINAL EXAM", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)

        txt2 = " • 102200134 - Nguyen Nho Gia Huy    \n • 102200131 - Hoang Huan  \t "
        ...
        def login_all():
            # Admin
            conn1 = sqlite3.connect("C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\Database\\CoffeeShop.db")
            ...
            # Guest
            conn2 = sqlite3.connect("C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\Database\\CoffeeShop.db")
            ...
            # Employee
            conn3 = sqlite3.connect("C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\Database\\CoffeeShop.db")
        ...
        def forgot_password():
            ...
            def change_password():
                db = sqlite3.connect("C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\Database\\CoffeeShop.db")
                cur = db.cursor()
        ...
        brand_name = Label(sign_up, text='LAP TRINH PYTHON', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_up, text="FINAL EXAM", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt3 = " • 102200134 - Nguyen Nho Gia Huy    \n • 102200131 - Hoang Huan  \t "
        ...
        def signup_all():
            ...
            if check_counter == 3:
                try:
                    connection = sqlite3.connect("C:\\Users\\yahwi\\OneDrive\\Desktop\\CoffeeShopManagentSystem-main\\CoffeeShopManagentSystem-main\\CoffeeManagementSystem\\Database\\CoffeeShop.db")
